...
eataly_nyc: set[int] = {
    # Eataly - NYC Downtown
    944632,  # Large Mixed Grocery Bag
    1025230,  # Mixed Grocery Bag
    # Eataly - NYC Flatiron
    237250,  # Mixed Grocery Bag
    646135,  # Large Mixed Grocery Bag
    # Eataly - SoHo
    20290466882225345,  # Small Mixed Grocery Bag
    20290467519777761,  # Large Mixed Grocery Bag
}
